...
class ButtonGroupDetails extends Component {
    ...
    genCharArray(charA, charZ) {
        ...
        for (i; i <= j; ++i) {
            ...
            a.push(<ReactBootstrap.OverlayTrigger trigger="focus" placement="bottom"
                                                  overlay={popoverBottom(letGot, this.props.metadata)} key={i}>
            ...
            <div>
                <ReactBootstrap.ButtonToolbar>
                    <ReactBootstrap.ButtonGroup bsSize="small">
                        <ReactBootstrap.OverlayTrigger trigger="focus" placement="bottom"
                                                       overlay={popoverBottom('char', this.props.metadata)}>
