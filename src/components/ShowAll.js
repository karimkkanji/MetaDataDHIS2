...
function IndicatorGroup({groupsGotten}){
    return( <PanelGroup accordion id={groupsGotten.displayName}>
        <Panel eventKey={groupsGotten.id} bsStyle="info">
            ...
            <Panel.Body collapsible>
                ...
                <h6>Quick info:</h6><Label bsStyle="default"
                                           style={{marginLeft: 10}}>{groupsGotten.periodType}</Label>&nbsp;
...
class ShowAll extends Component{
    ...
    componentDidMount(){
        ...
        switch (this.props.groups) {
            case "programs":whatGroup="programGroups";toHighlight="programs";break;
            case "dataelements":whatGroup="dataElementGroups";toHighlight="dataElements";break;
            case "indicators":whatGroup="indicatorGroups";toHighlight="indicators";break;
            default:whatGroup="null";break;
        }
        fetch(
            ...
            {groups==="indicators"?ReactDOM.render(<DisplayElements elem={jsonData.indicators}/>, document.querySelector("#display")):null}
            {groups==="dataelements"?ReactDOM.render(<DisplayElements elem={jsonData.dataElements}/>, document.querySelector("#display")):null}
